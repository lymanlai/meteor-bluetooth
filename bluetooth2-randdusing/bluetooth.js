...
if (Meteor.isClient) {
  ...
  Template.body.events({
    ...
    'click button.initialize': initialize,
    'click button.enable': enable,
    'click button.disable': disable,
    'click button.startScan': startScan,
    'click button.stopScan': stopScan,
    'click button.retrieveConnected': retrieveConnected,
    'click button.isInitialized': isInitialized,
    'click button.isEnabled': isEnabled,
    'click button.isScanning': isScanning
  });
